...
data class DailyNote(
    ...
    val resinRecoveryTime: Long,

    /**
     * 每日委托完成数量
     */
    @SerialName("finished_task_num")
    val finishedTask: Short,
    ...
    val resinDiscountRemain: Short,

    /**
     * 周本减半最大次数
     */
    @SerialName("resin_discount_num_limit")
    val resinDiscountLimit: Short,

    /**
     * 目前派遣数量
     */
    @SerialName("current_expedition_num")
    val currentExpedition: Short,

    /**
     * 最大派遣数量
     */
    @SerialName("max_expedition_num")
    val maxExpedition: Short,

    /**
     * 派遣角色具体状态
     */
    @SerialName("expeditions")
    val expeditions: List<AvatarExploreInfo>,
